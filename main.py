...
def start_monitor(port, monitor=None, primary=None, standby=None):
    with MonitorServer((HOSTNAME, port), monitor, primary, standby, MonitorHandler ) as monitor_srv:
...
def start_instance(port, monitor=None, primary=None, standby=None):
